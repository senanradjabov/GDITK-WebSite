...
const getUrl = (slug: string) => `${adminPaths.documents}/admin/${slug}`;
const deleteUrl = (slug: string) => `${adminPaths.documents}/admin/delete/${slug}`;
const addUrl = `${adminPaths.documents}/admin/add`;

const DocumentsUpsetPage: React.FC = () => {
...
export default DocumentsUpsetPage;
